...
})({"60xPa":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "2f7cb95d42241f3c24d8c2b5c241af47";
// @flow
...
},{}],"3pawT":[function(require,module,exports) {
var define;
!(function (e, o) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = o() : "function" == typeof define && define.amd ? define(o) : (e = "undefined" != typeof globalThis ? globalThis : e || self).RevealZoom = o();
})(this, function () {
  "use strict";
  /*!
  ...
  var e = {
    ...
    init: function (e) {
      e.getRevealElement().addEventListener("mousedown", function (t) {
        var n = (/Linux/).test(window.navigator.platform) ? "ctrl" : "alt", i = (e.getConfig().zoomKey ? e.getConfig().zoomKey : n) + "Key", d = e.getConfig().zoomLevel ? e.getConfig().zoomLevel : 2;
    ...
    var e = 1, t = 0, n = 0, i = -1, d = -1, s = ("WebkitTransform" in document.body.style) || ("MozTransform" in document.body.style) || ("msTransform" in document.body.style) || ("OTransform" in document.body.style) || ("transform" in document.body.style);
    function r(o, t) {
      var n = l();
      if ((o.width = o.width || 1, o.height = o.height || 1, o.x -= (window.innerWidth - o.width * t) / 2, o.y -= (window.innerHeight - o.height * t) / 2, s)) if (1 === t) (document.body.style.transform = "", document.body.style.OTransform = "", document.body.style.msTransform = "", document.body.style.MozTransform = "", document.body.style.WebkitTransform = ""); else {
        var i = n.x + "px " + n.y + "px", d = "translate(" + -o.x + "px," + -o.y + "px) scale(" + t + ")";
    ...
    function m() {
      var o = .12 * window.innerWidth, i = .12 * window.innerHeight, d = l();
...
},{}]},["60xPa","3pawT"], "3pawT", "parcelRequire3d4e")

//# sourceMappingURL=demo.c241af47.js.map
